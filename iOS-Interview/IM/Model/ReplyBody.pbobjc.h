...
typedef GPB_ENUM(ReplyBody_FieldNumber) {
  ReplyBody_FieldNumber_Key = 1,
  ReplyBody_FieldNumber_Code = 2,
  ReplyBody_FieldNumber_Message = 3,
  ReplyBody_FieldNumber_Timestamp = 4,
  ReplyBody_FieldNumber_Data_p = 5,
};

@interface ReplyBody : GPBMessage
