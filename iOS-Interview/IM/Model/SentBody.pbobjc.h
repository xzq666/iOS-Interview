...
typedef GPB_ENUM(SentBody_FieldNumber) {
  SentBody_FieldNumber_Key = 1,
  SentBody_FieldNumber_Timestamp = 2,
  SentBody_FieldNumber_Data_p = 3,
};

@interface SentBody : GPBMessage
