  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "action",
        .dataTypeSpecific.className = NULL,
        .number = Message_FieldNumber_Action,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(Message__storage_, action),
        .flags = GPBFieldOptional,
      ...
      },
      {
        .name = "format",
        .dataTypeSpecific.className = NULL,
        .number = Message_FieldNumber_Format,
        .hasIndex = 7,
        .offset = (uint32_t)offsetof(Message__storage_, format),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
      {
